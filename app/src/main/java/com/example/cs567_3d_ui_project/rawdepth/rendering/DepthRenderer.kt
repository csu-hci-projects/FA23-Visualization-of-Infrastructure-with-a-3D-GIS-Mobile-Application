...
import com.example.cs567_3d_ui_project.rawdepth.DepthData
...
class DepthRenderer() {
    ...
    companion object {
        ...
        private const val VERTEX_SHADER_NAME = "shaders/background_show_depth_color_visualization.vert"
        private const val FRAGMENT_SHADER_NAME = "shaders/background_show_depth_color_visualization.frag"
        const val BYTES_PER_FLOAT = java.lang.Float.SIZE / 8
        private val BYTES_PER_POINT: Int = BYTES_PER_FLOAT * DepthData.FLOATS_PER_POINT
