...
class Mesh(
    ...
    fun lowLevelDraw() {
        ...
        if (indexBuffer == null) {
            ...
            val vertexCount: Int = vertexBuffers[0]!!.getNumberOfVertices()
            for (i in 1 until vertexBuffers.size) {
                val iterCount: Int = vertexBuffers[i]!!.getNumberOfVertices()
    ...
    companion object {
        ...
        fun createFromAsset(
            ...
            render.getAssets().open(assetFileName!!).use { inputStream ->
                val obj =
