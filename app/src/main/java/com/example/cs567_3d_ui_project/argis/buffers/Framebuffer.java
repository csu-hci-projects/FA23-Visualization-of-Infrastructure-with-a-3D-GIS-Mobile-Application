...
public class Framebuffer implements Closeable {
   ...
   *
   * <p>In order to render to the {@link Framebuffer}, use {@link ARRenderer#draw(com.example.cs567_3d_ui_project.argis.Mesh, com.example.cs567_3d_ui_project.argis.Shader,
   * Framebuffer)}.
   */
